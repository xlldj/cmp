        ...
        <div >
          ...
          <div className="lineChartWrapper">
            ...
            >
              ...
              <YAxis axisLine={{stroke:'#ddd'}} domain={[0, 'dataMax']} tickLine={false} tick={<CustomizedYAxisTick />} />
              <Tooltip isAnimationActive={false} cursor={{ stroke: '#222', strokeWidth: 1 }} content={<CustomizedTooltip monthStr={monthStr} />} />
              <Legend align='left' verticalAlign="top" margin={{left:-20}} wrapperStyle={{paddingLeft:20,top:-15}} content={<CustomizedLegend  />} height={36}  />
