      ...
      <div className="infoList">
        <ul>
          ...
          <li>
            ...
            />
            {typeError ? (
              <span className="checkInvalid">请选择期限类型！</span>
            ) : null}
          </li>
          {type === 1 ? (
            <li>
              ...
              />
              {rangeError ? (
                <span className="checkInvalid">开始结束时间不能相同！</span>
              ) : null}
            </li>
          ) : null}
          {type === 2 ? (
            <li>
              ...
              <input
                ...
                onBlur={this.checkTimeLimit}
                value={timeLimit}
              />
              {timeLimitError ? (
                <span className="checkInvalid">红包期限不能为空！</span>
              ) : null}
            </li>
          ) : null}
          <li>
