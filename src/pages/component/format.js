...
Format.hourMinute = (o) => { // o is object, like {hour: 4, minute: 34}
  let h = Format.adding0(o.hour), m = Format.adding0(o.minute)
  return h + ':' + m
}
...
Format.rangeToHour = (o) => { // this is used for time ranges like {startTime: {hour: 0, minute: 3}, endTime: {hour: 8, minute: 33}}
  return `${Format.adding0(o.startTime.hour)}:${Format.adding0(o.startTime.minute)}-${Format.adding0(o.endTime.hour)}:${Format.adding0(o.endTime.minute)}`
}
