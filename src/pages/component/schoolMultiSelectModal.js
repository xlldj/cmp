    ...
    return (
      ...
      >
        <div className="giftStatus searchLine maintainerSchSel">
          ...
          />
          <div>
            <Button className="mgr10" onClick={this.clearSchoolLimit}>
              不限制学校
            </Button>
            <Button className="mgr10" onClick={this.toggleAll}>
              {all ? '取消全选' : '全选'}
            </Button>
            <Button
...
export default connect(mapStateToProps, {})(SchoolMultiSelectModal);
