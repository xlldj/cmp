...
class EmployeeContainer extends React.Component {
  render () {
    return (
      <div>
        <Switch>
          <Route path='/employee/list/detail/:id' render={(props) => (<EmployeeInfo hide={this.props.hide} {...props} />)} />
          <Route path='/employee/list/add' render={(props) => (<EmployeeInfo hide={this.props.hide} {...props} />)} />
