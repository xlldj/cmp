    ...
    return (
      <div className='disp'>
        <div className='contentArea'>
          <SearchLine  searchInputText='学校名称' searchingText={this.state.searchingText} pressEnter={this.pressEnter} changeSearch={this.changeSearch}  leftDespTitle1='所有学校报修设备总数:' leftDespDetail1={totalAmount} selector1={selector1} />
