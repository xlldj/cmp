  ...
  fetchData = body => {
    ...
    const cb = json => {
      ...
      if (json.error) {
        ...
        let rechargePoints = json.data.rechargePoints,
          withdrawPoints = json.data.withdrawPoints
          ...
          <div className="lineChartWrapper">
            ...
            >
              ...
              <Line
                name={
                  compare
                    ? `${DAY[timeSpan]}充值${amountOrProfit}`
                    : `充值${amountOrProfit}`
                }
                dataKey="y"
                stroke="#4aaaef"
              ...
              <Line
                name={
                  compare
                    ? `${DAY[timeSpan]}提现${amountOrProfit}`
                    : `提现${amountOrProfit}`
                }
                dataKey="withdraw"
                stroke="#97da7b"
              ...
              {compare ? (
                <Line
                  name={
                    compare
                      ? `${LASTDAY[timeSpan]}充值${amountOrProfit}`
                      : `充值${amountOrProfit}`
                  }
                  dataKey="lastReceive"
                  stroke="#ffa312"
              ...
              {compare ? (
                <Line
                  name={
                    compare
                      ? `${LASTDAY[timeSpan]}提现${amountOrProfit}`
                      : `提现${amountOrProfit}`
                  }
                  dataKey="lastWithdraw"
                  stroke="#ff5555"
                  dot={false}
                  activeDot={{ strokeWidth: 2 }}
                />
