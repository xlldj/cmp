  ...
  fetchData = body => {
    ...
    const cb = json => {
      ...
      if (json.error) {
        ...
        let receivePoints = json.data.receivePoints,
          usePoints = json.data.usePoints
          ...
          <div className="lineChartWrapper">
            ...
            >
              ...
              <Line
                name={
                  compare
                    ? `${DAY[timeSpan]}领取${amountOrProfit}`
                    : `领取${amountOrProfit}`
                }
                dataKey="y"
                stroke="#4aaaef"
              ...
              <Line
                name={
                  compare
                    ? `${DAY[timeSpan]}使用${amountOrProfit}`
                    : `使用${amountOrProfit}`
                }
                dataKey="use"
                stroke="#97da7b"
              ...
              {compare ? (
                <Line
                  name={
                    compare
                      ? `${LASTDAY[timeSpan]}领取${amountOrProfit}`
                      : `领取${amountOrProfit}`
                  }
                  dataKey="lastReceive"
                  stroke="#ffa312"
              ...
              {compare ? (
                <Line
                  name={
                    compare
                      ? `${LASTDAY[timeSpan]}使用${amountOrProfit}`
                      : `使用${amountOrProfit}`
                  }
                  dataKey="lastUse"
                  stroke="#ff5555"
