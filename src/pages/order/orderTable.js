...
//import Button from 'antd/lib/button'd
    ...
    return (
      <div className='contentArea'>
        <SearchLine 
          ...
          selector3={<BasicSelector allTitle='所有使用状态' staticOpts={STATUS} selectedOpt={status} changeOpt={this.changeStatus} />} 
        />
